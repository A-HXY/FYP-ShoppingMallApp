...
import com.example.storepro.utils.DensityUtil;
            ...
            for (int i = 0; i < hot_product_list.size(); i++) {
                ...
                myLinear.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String brief = hot_product_list.get(i).getBrief();
                        String details = hot_product_list.get(i).getDetails();
                        //ProductBean productBean = new ProductBean(name, cover_price, figure, product_id);
                        ProductBean productBean = new ProductBean();
                        productBean.setName(name);
                        productBean.setFigure(figure);
                        productBean.setCover_price(cover_price);
                        productBean.setProduct_id(product_id);
                        productBean.setBrief(brief);
                        productBean.setDetails(details);
