<template>
    <div class="Box">
      ...
      <el-table :data="tableDataFormat" class="tableBox">
        <el-table-column label="ID" prop="cid" align="center" width="100px"/>
        <el-table-column label="User ID" prop="uid" align="center" width="100px"/>
        <el-table-column label="Product ID" prop="gid" align="center" width="100px"/>
        <el-table-column label="Content" prop="ccontent" align="center"/>
        <el-table-column label="Time" prop="ccreateTime" align="center" width="160px"/>
        <el-table-column label="Options" fixed="right" align="center" width="100px">
          <template #default="scope">
            <el-button size="mini" :type="scope.row.cstatus == 1 ? 'danger':'success'" @click="changeStatusBtn(scope.row)" icon="el-icon-edit">{{scope.row.cstatus == 1 ? 'disable':'pass'}}</el-button>
          </template>
        </el-table-column>
      </el-table>
