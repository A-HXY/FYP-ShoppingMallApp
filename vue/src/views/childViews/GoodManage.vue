<template>
    <div>
      ...
      <div class="funBtn">
        <div>
          <h3 style="display: inline-block;">Product Category：</h3>
          <el-cascader v-model="value" :options="options" @change="handleSelect" />
          <el-button type="success" @click="showAddGoodView" style="margin-left: 10px;margin-right: 10px;">Add Product</el-button>
        </div>
        <div class="searchBox">
          <el-input class="w-50 m-2"
            size="large" v-model="queryWord" placeholder="key words...">
            <template #append>
      ...
      <div class="Box">
        <!-- 展示信息的表格 -->
        <el-table :data="tableDataFormat" class="tableBox" stripe empty-text="Select">
          <el-table-column label="ID" prop="gid" width="100px" align="center"/>
          <el-table-column label="Name" prop="gname" width="230px" align="center"/>
          <el-table-column label="Image" width="80px" align="center">
          ...
          <el-table-column label="Price" prop="gprimalPrice" width="100px"  align="center" />
          <el-table-column label="Count" prop="gnumber" width="100px" align="center"/>
          <el-table-column label="CreateTime" prop="gcreateTime" width="210px" align="center"/>
          <el-table-column label="UpdateTime" prop="gupdateTime" width="210px" align="center"/>
          <el-table-column label="Options" fixed="right" align="center" width="250px">
            <template #default="scope">
              <el-button size="mini" @click="handleEdit(scope.row)" icon="el-icon-edit">Edit</el-button>
              <el-button size="mini" :type="scope.row.gstatus == 1 ? 'danger':'success'" @click="handleDelete(scope.row)" icon="el-icon-delete">{{scope.row.gstatus == 1 ? 'Delist':'Listing'}}</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 分页组件 -->
      ...
      <!-- 弹出层 编辑 -->
      <el-dialog v-model="dialogFormVisibleEdit" title="Edit">
        <el-form :model="goodInfoEdit" class="formBox">
          <el-form-item label="Product image：" :label-width="formLabelWidth">
            <el-upload
              action=""
              class="avatar-uploader"
              :auto-upload="false"
            ...
            <el-button @click="uploadEdit()">upload</el-button>
          </el-form-item>
          ...
          <el-form-item label="Details：" :label-width="formLabelWidth">
        ...
        <template #footer>
          <span class="dialog-footer">
            <el-button @click="dialogHidden" icon="el-icon-close">Cancel</el-button>
            <el-button type="primary" @click="editGood" icon="el-icon-success">Submit</el-button>
          </span>
        </template>
      </el-dialog>
    </div>
