    ...
    <div class="Box">
      <div class="funBox">
        <el-cascader v-model="value" :options="options" @change="handleSelect" />
          <el-button type="success" @click="addTypeBtn" style="margin-left: 10px;margin-right: 10px;">Add</el-button>
      </div>

      <!-- 展示用户信息的表格 -->
      <el-table :data="tableDataFormat" class="tableBox">
        <el-table-column label="Type ID" prop="gtype_id" align="center"/>
        <el-table-column label="Type Name" prop="gtype_name" align="center"/>
