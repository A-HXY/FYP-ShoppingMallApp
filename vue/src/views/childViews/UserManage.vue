<template>
  <div>
    <!-- 新增和搜索 -->
    <div class="funcBox">
      <el-button size="mini" type="primary" @click="addUser" icon="el-icon-plus">Add User</el-button>&nbsp;
      <div class="inputbox">
        <el-input size="mini" v-model="queryWord" placeholder="keyword...">
          <template #append>
    ...
    <el-table :data="tableDataFormat" class="tableBox">
      ...
      <el-table-column label="Username" prop="username" width="120px" />
      <el-table-column label="gender" prop="gender" :formatter="formatSex" />
      <el-table-column label="Account" prop="loginname" width="120px" />
      <el-table-column label="Phone No." prop="phone" width="160px" />
      <el-table-column label="CreateTime" prop="create_time" />
      <el-table-column label="UpdateTime" prop="update_time" />
      <el-table-column label="Options" fixed="right" align="center">
        <template #default="scope">
          <el-button size="mini" @click="handleEdit(scope.row)" icon="el-icon-edit">Edit</el-button>
          <el-button size="mini" :type="scope.row.del_status == 0 ? 'danger':'success'" @click="handleDelete(scope.row)" icon="el-icon-delete">{{scope.row.del_status == 0 ? 'Freeze':'Unfreeze'}}</el-button>
        </template>
      </el-table-column>
    </el-table>
