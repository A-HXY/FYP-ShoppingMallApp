<template>
    <div class="Box">
      ...
      <el-table :data="tableDataFormat" class="tableBox">
        <el-table-column label="Order ID" prop="oid" width="120px"/>
        <el-table-column label="User ID" prop="uid" width="120px"/>
        <el-table-column label="Address ID" prop="addrId" width="120px" />
        <el-table-column label="Order No" prop="orderIndex" />
        <el-table-column label="Delivery ID" prop="freightIndex" width="120px" />
        <el-table-column label="Total" prop="total" width="160px" />
        <el-table-column label="CreateTime" prop="createTime" />
        <el-table-column label="Options" fixed="right" align="center">
          <template #default="scope">
            <el-button size="mini" type="success" @click="orderDetail(scope.row)" icon="el-icon-s-order">Detail</el-button>
            <el-button size="mini" type="danger" @click="sendGood(scope.row)" icon="el-icon-s-promotion">Ship</el-button>
          </template>
        </el-table-column>
      </el-table>
