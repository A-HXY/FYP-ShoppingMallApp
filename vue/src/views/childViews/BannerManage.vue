<template>
    <div class="Box">
      ...
      <div class="funBtn">
        <div>
          <el-button type="success" @click="AddBtn" style="margin-left: 10px;margin-right: 10px;">Add Banner</el-button>
        </div>
      </div>
      ...
      <el-table :data="tableDataFormat" class="tableBox">
        ...
        <el-table-column label="Image" align="center" width="200px">
        ...
        <el-table-column label="Status" align="center" width="500px">
          <template #default="scope">
            <el-text class="mx-1" :type="scope.row.bstatus == 0 ? 'danger':'success'">{{scope.row.bstatus == 1 ? 'pass':'disable'}}</el-text>
          </template>
        </el-table-column>
        <el-table-column label="Options" fixed="right" align="center" width="200px">
          <template #default="scope">
            <el-button size="mini" :type="scope.row.bstatus == 1 ? 'danger':'success'" @click="changeStatusBtn(scope.row)" icon="el-icon-edit">{{scope.row.bstatus == 1 ? 'disable':'pass'}}</el-button>
          </template>
        </el-table-column>
      </el-table>
